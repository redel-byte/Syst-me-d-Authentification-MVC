                ...
                <div class="w-full max-w-md relative overflow-hidden">
                    ...
                    <div id="loginForm" class="form-container active-form">
                        <div class="bg-white rounded-2xl shadow-2xl p-8">
                            ...
                            <form id="loginFormElement" action="/Auth/Logincontroller" method="post">
                                <div class="space-y-6">
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input name="email" type="email" id="loginEmail" class="form-input w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-purple-500 transition" placeholder="you@example.com" required>
                                        </div>
                                    </div>
