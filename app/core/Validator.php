...
class Validator
{
    ...
    // regex for email
    private static $emailRegex = "/^[a-zA-Z0-9._%+-]+@(gmail|outlook|yahoo|hotmail)\\.(com|ma|fr)$/";  // Fixed
    ...
    {
        // Use filter_var for better email validation
        if (!filter_var($input, FILTER_VALIDATE_EMAIL)) {
            return false;
        }
        
        // Additional regex check if you want specific domains
